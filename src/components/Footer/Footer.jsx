      ...
      <div className={footerCss.innerFooter}>
        ...
        <div className={footerCss.sec2}>
          <div className={[footerCss.box1, footerCss.box].join(" ")}>
            <div className={footerCss.boxTtl}>ABOUT Food Express</div>
        ...
        <div className={footerCss.sec3}>
          ...
          properties of their respective owners. 2008-2022 © Food Express™ Ltd.
          All rights reserved.
        </div>
      </div>
    </div>
